...
pub struct Config {
    ...
    /// Editor keybinding mode for the TUI composer.
    pub tui_editor_mode: TuiEditorMode,
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let config = Self {
            ...
            tui_editor_mode: cfg.tui.as_ref().map_or(TuiEditorMode::Default, |t| t.editor_mode),
            otel: {
